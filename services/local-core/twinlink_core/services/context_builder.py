"""クローン実行用コンテキストパッケージ生成（twinlink.md §20）。"""
...
from twinlink_core.models import CloneAgent, CloneContextPackage, LocalProject, MemoryItem
...
from twinlink_core.services.token_counter import estimate_json_tokens
...
def build_context_package(
    ...
    """外部エージェントへ渡す最小コンテキストを生成する（twinlink.md 方針修正 §4）。"""
